      ...
      <media-controls data-controls="" class="${controls}">
        <media-tooltip-group>
          ...
          <div class="${buttonGroupEnd}">
            ...
            <button commandfor="settings-menu" aria-label="Settings" class="${cn(button.base, button.subtle, button.icon, 'group')}">
              ${renderIcon('gear', { class: cn(icon, menu.settingsIcon) })}
            </button>
            <media-menu id="settings-menu" side="top" align="center" class="${cn(popup.popover, menu.root, menu.settings)}">
